      ...
      <section className="relative sm:min-h-[88vh] flex flex-col sm:flex-row sm:items-end overflow-hidden">
          ...
          <>
            ...
            <div className="absolute top-0 left-0 right-0 h-[55vh] sm:hidden">
              <Image
                ...
                priority
              />
              {/* Gradient: transparent top, dark bottom (from 45%) */}
              <div className="absolute inset-0 bg-gradient-to-b from-transparent from-[40%] via-[#0a0f1c]/75 via-[65%] to-[#0a0f1c]" />
            </div>
        ...
        <div className={`relative z-10 w-full px-5 sm:px-16 pb-10 sm:pb-24 ${hasPhoto ? "sm:max-w-[55%]" : "max-w-3xl"}`}>
          ...
          >
            ...
            <span className="rounded-full bg-[#c9a96e]/10 border border-[#c9a96e]/30 px-3 py-1 text-[10px] tracking-[0.25em] text-[#c9a96e] font-semibold uppercase backdrop-blur-sm">
          ...
          {/* Role */}
          <p
            className="anim-fade-up mt-4 text-sm text-slate-400/90 tracking-wide"
          ...
          {/* Bio */}
          <p
            className="anim-fade-up mt-5 text-sm text-slate-300/80 leading-relaxed max-w-md"
            style={{ animationDelay: "260ms" }}
          >
            Finance student with hands-on experience in treasury and ALM at{" "}
            <span className="text-white/90 font-medium">Intesa Sanpaolo</span> and
            M&amp;A advisory at{" "}
            <span className="text-white/90 font-medium">Epyon Vivida</span>.
          ...
          >
            ...
            <Link
              href="/projects"
              className="rounded-full border border-white/20 px-6 py-3 text-xs font-semibold text-white/80 hover:border-white/40 hover:bg-white/5 active:scale-95 transition-all"
            >
              View Projects →
            </Link>
          </div>
